...
public class TunerConstants {
    ...
    private static final Slot0Configs steerGains = new Slot0Configs()
        .withKP(45).withKI(0).withKD(1)
        .withKS(0.23233).withKV(2.6636).withKA(0.047445)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    // When using closed-loop control, the drive motor uses the control
    // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
    private static final Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.079934).withKI(0).withKD(0)
        .withKS(0.2262).withKV(0.12477).withKA(0.012364);
    ...
    private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                ...
                .withStatorCurrentLimit(Amps.of(45)) //changed from 60 to 45 
    ...
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.343017578125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.12841796875);
