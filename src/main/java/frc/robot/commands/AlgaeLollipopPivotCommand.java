...
public class AlgaeLollipopPivotCommand extends Command {
  private AlgaePivotSubSystem pivot;
  PIDController controller;
  /** Creates a new DropIntakeCommand. */
  public AlgaeLollipopPivotCommand(AlgaePivotSubSystem pivot) {
    this.pivot = pivot;
    // Use addRequirements() here to declare subsystem dependencies.
    addRequirements(pivot);
    controller = new PIDController(0.008, 0, 0); 
    controller.setSetpoint(25); //UNTESTED and needs to be tuned
