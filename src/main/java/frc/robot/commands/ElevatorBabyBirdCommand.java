...
public class ElevatorBabyBirdCommand extends Command {

  private ElevatorSubSystem elevator;
  private PIDController controller;

  /** Creates a new ElevatorSixFeetCommand. */
  public ElevatorBabyBirdCommand(ElevatorSubSystem elevator) {
    // Use addRequirements() here to declare subsystem dependencies.
    this.elevator = elevator;
    addRequirements(elevator);
    controller = new PIDController(0.03, 0, 0); //0.01025
    controller.setSetpoint(10.0); //NEEDS TO BE TUNED TO ACTUAL HEIGHT
